...
if {${command} == "open"} {
  ...
  # Create sim path
  if {![file exists ${simulation_result_path}]} {
    file mkdir ${simulation_result_path}
    file copy ${script_path}/wcfg/xsim.wcfg ${simulation_result_path}
    add_files -norecurse -fileset sim_1 ${simulation_result_path}/xsim.wcfg
  }
  ...
  set_property xsim.view ${simulation_result_path}/xsim.wcfg [get_filesets sim_1]
